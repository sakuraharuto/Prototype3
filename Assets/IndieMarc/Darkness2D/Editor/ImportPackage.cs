...
namespace IndieMarc.Darkness
{
    ...
    public class ImportPackage
    {
        ...
        {
            if (!completed && DoesAssetExists("Assets/IndieMarc/Darkness2D/Prefabs/Darkness.prefab")){
                completed = true;
                marked_for_save = false;

                CreateSortingLayer("Perspective");
                CreateSortingLayer("Top");
                SetPrefabLayer("Assets/IndieMarc/Darkness2D/Prefabs/TorchItemTopDown.prefab", "Perspective");
                SetPrefabLayer("Assets/IndieMarc/Darkness2D/Prefabs/TorchStaticTopDown.prefab", "Perspective");
                SetPrefabLayer("Assets/IndieMarc/Darkness2D/Prefabs/Darkness.prefab", "Top");
